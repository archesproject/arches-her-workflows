"""
Django settings for arches_her_workflows project.
"""
...
DATATYPE_LOCATIONS.append("arches_her_workflows.datatypes")
FUNCTION_LOCATIONS.append("arches_her_workflows.functions")
ETL_MODULE_LOCATIONS.append("arches_her_workflows.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_her_workflows.search_components")
...
SECRET_KEY = "django-insecure-l%44m$q%w9s(bp3s%xtso^v*n%133yoq9mdpvj7zq*kj834z%9"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_her_workflows.urls"
ROOT_HOSTCONF = "arches_her_workflows.hosts"

DEFAULT_HOST = "arches_her_workflows"
...
ELASTICSEARCH_PREFIX = "arches_her_workflows"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_her_workflows.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    "pgtrigger",
    # "silk",
    "arches_her_workflows",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_her_workflows.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_her_workflows"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_her_workflows.search.es_mapping_modifier.EsMappingModifier"]
