...
module.exports = {
  input: {
    path: "./arches_her_workflows/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_her_workflows/locale", // output path of all created files
